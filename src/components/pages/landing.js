 ...
 const Landing = () => {
     return(
        ...
        <form className="box">
             ...
             <p className="is-1">Yet another place where you can store tasks you have to do. To start you need to log in or create an account if you havn't one already.</p>
            <br/>
